...
function drawVoronoi(){
  // render a voronoi diagram based on the objects stored in markers
...
function setFill(x,y){
  //given a particular location(x,y), determine the closest marker
  // and set the fill value to its region color
  let minDist = -1;
  let minIndex = -1;
...
class MovableMarker{
  ...
  regionAdd(){
    //increase the count of squares closest to this point 
    this.regionArea++;
  }
  resetCount(){
    this.regionArea=0;
